...
class QualityReport:
    ...
    python_code_unit_count: int
    function_level_code_piece_count: int
    toc_page_count: int
    ...
    python_ast_parseable_ratio: float
    code_indentation_issue_ratio: float
    split_identifier_candidate_ratio: float
    function_boundary_violation_ratio: float

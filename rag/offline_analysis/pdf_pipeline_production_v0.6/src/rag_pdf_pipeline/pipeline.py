...
class RAGPDFPipeline:
    ...
    def run(
        ...
        return {
            ...
            "python_code_unit_count": report.python_code_unit_count,
            "function_level_code_piece_count": report.function_level_code_piece_count,
            "python_ast_parseable_ratio": report.python_ast_parseable_ratio,
            "code_indentation_issue_ratio": report.code_indentation_issue_ratio,
            "split_identifier_candidate_ratio": report.split_identifier_candidate_ratio,
            "function_boundary_violation_ratio": report.function_boundary_violation_ratio,
